...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/civicrm?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost:3306/civicrmdb?new_link=true');
  }
}
...
$civicrm_root = 'C:/xampp/htdocs/civicrm/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:/xampp/htdocs/civicrm\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '7a7e22ffd2ca5c16541b2d9a2b213270');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:/xampp/htdocs/civicrm\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
